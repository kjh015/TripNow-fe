...
const MyPage = () => {
  const [member, setMember] = useState({
    loginId: '', email: '', nickname: '', gender: '',
    roles: [], regDate: '', birthDate: '', age: ''
  });
        ...
        <div className="modal show fade d-block" tabIndex={-1} style={{ background: 'rgba(0,0,0,0.28)' }}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body"><p>정말 탈퇴하시겠습니까?</p></div>
          ...
          <div className="col-12 col-md-7 col-lg-5">
            <div className="card shadow rounded-4 p-4 text-center border-0" style={{ background: "#fffdfcf2" }}>
                ...
                <div className="row g-2 justify-content-center">
                  ...
                  <div className="col-12">
                    <div className="d-flex align-items-center bg-light rounded-3 px-3 py-2 shadow-sm mb-2">
                      ...
                      <span className="ms-auto fw-bold">{member.regDate ? formatDate(member.regDate) : '-'}</span>
                    </div>
                  </div>
                  ...
                  <div className="col-12 col-sm-6">
                    <div className="d-flex align-items-center bg-light rounded-3 px-3 py-2 shadow-sm mb-2">
                      ...
                      <span className="ms-auto fw-bold">{member.birthDate ? member.birthDate.substring(0, 10) : '-'}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="gap-2 mt-3">
                ...
                <button className="btn btn-outline-danger rounded-pill px-3 shadow-sm" onClick={() => setShowConfirm(true)}>
